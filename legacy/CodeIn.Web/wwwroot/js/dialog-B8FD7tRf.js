...
class NewslettersApi {
  static Base = "/newsletters";
  Suscribe = NewslettersApi.Base + "/suscribe";
}
class CandidatesApi {
  static Base = "/candidates";
  Submissions = CandidatesApi.Base;
}
class QuestionsApi {
  static Base = "/questions";
  Submissions = QuestionsApi.Base;
}
class LeadsApi {
  static Base = "/lead";
  Submissions = LeadsApi.Base + "/submissions";
}
class AuthApi {
  static Base = "/auth";
  Login = AuthApi.Base + "/login";
}
class RoutesApi {
  Auth = new AuthApi();
  Leads = new LeadsApi();
  Questions = new QuestionsApi();
  Newsletters = new NewslettersApi();
  Candidates = new CandidatesApi();
}
const ApiRoutes = new RoutesApi();
class Dialog {
  el;
  beforeOpen;
  afterOpen;
  ...
  constructor(props) {
    ...
    const close = this.el.querySelector(":scope button.close");
    if (close) this.close = new Button({
      el: close,
      onClick: this.onClose.bind(this)
    });
    const cancel = this.el.querySelector(":scope button.dialog-cancel");
    if (cancel) this.cancel = new Button({
      el: cancel,
      onClick: this.onCancel.bind(this)
    });
    const action = this.el.querySelector(":scope button.dialog-action");
